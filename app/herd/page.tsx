      ...
      <main className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
        ...
        {homeCountyMissing && (
          <Card shadow="sm" className="mt-8 p-5">
            <p className="font-dm-sans text-[16px] font-semibold text-ink">Set your home county to value your herd</p>
            <p className="mt-1 font-dm-sans text-[16px] text-secondary-ink">
        ...
        {lots.length === 0 && (
          <p className="mt-8 font-dm-sans text-[16px] text-secondary-ink">
