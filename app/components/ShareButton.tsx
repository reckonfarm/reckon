...
export default function ShareButton({
  ...
  return (
    <button
      ...
      className="inline-flex min-h-[48px] items-center gap-1.5 rounded-lg border border-forest-green/15 px-3 py-1.5 font-dm-sans text-sm font-medium text-secondary-ink transition-colors hover:bg-forest-green/5 hover:text-forest-green"
    >
