...
export default function TapDebug() {
  ...
  useEffect(() => {
    ...
    // Reduced set: pointerdown tells us where the finger lands; pointercancel
    // tells us if iOS cancels mid-gesture. The rest was noise.
    const types = ['pointerdown', 'pointercancel']
