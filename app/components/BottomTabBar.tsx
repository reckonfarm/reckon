...
// indicator.
//
// BLOCK 12 (12.1): RECORD IS THE PILL AGAIN (RecordFab), not an item here. It
// moved into this bar in 11.4 to get every floating element off the page; PK
// wanted the pill back, and it returns under the same rule — the phone body
// reserves the bar AND the pill zone, and the overlap check tests the pill on
// every screen. The bar is the four destinations and nothing else.
